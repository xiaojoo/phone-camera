...
TABLES = {
    ZH: {
        ...
        "lens.switch": "切到{lens}",
        "lens.tip": "切换手机的前后摄像头",
        "lens.needSession": "先连接手机，再切换摄像头",
        "lens.failed": "切换摄像头失败：{detail}",
        "light.on": "开补光",
        "light.off": "关补光",
        "light.tip": "后置用闪光灯，前置用屏幕补光",
        "light.needSession": "先连接手机，再开关补光",
        "light.failed": "切换补光失败：{detail}",
        "view.fullscreen": "全屏",
    ...
    EN: {
        ...
        "lens.back": "rear",
        "lens.front": "front",
        "lens.switch": "Switch to {lens}",
        "lens.tip": "Switch the phone between its cameras",
        "lens.needSession": "Connect to the phone before switching cameras",
        "lens.failed": "Could not switch the camera: {detail}",
        "light.on": "Light on",
        "light.off": "Light off",
        "light.tip": "Torch on the rear camera, screen light on the front",
        "light.needSession": "Connect to the phone before switching the light",
        "light.failed": "Could not switch the light: {detail}",
